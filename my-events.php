...
<hr>
<h4>EVENTS YOU ARE HOSTING @ INNOVATE 2k17 :</h4>
<?php
$server="localhost";
$user="techzon2";
$pass="RwIKlQ#nQ";
...
$sql1="SELECT eventname,aboutevent,eventdetails FROM eventdetails WHERE userid1='$studentid' OR userid2='$studentid' OR userid3='$studentid'";
...
if(mysqli_num_rows($query1)>0)
 ...
 echo '<div class="prop" style="background-color:#FFF4B4; border-style:solid; border-width:1px; border-color:transparent;">';
    ...
    echo $count.'.&nbsp;'.$row1['eventname'].'<br><u>ABOUT EVENT</u> : <br>'.$row1['aboutevent'].'<br><u>EVENT DETAILS</u> : <br>'.$row1['eventdetails'];
    if($row1['eventdetails']==null)
    {
    echo '<h4>We found that you have not updated your event details. UPDATE EVENT DETAILS link is now open. <a href="update-event-details.php">CLICK HERE</a> to add event details.</h4>';
    }
    echo '</div>';
    echo '<br>';
    $count++;
 	...
 	echo "You are hosting 0 / NO events in INNOVATE 2k17";
 }
}
mysqli_close($connect);
?>
<code style="font-size:15px;">To change any details mentioned here please contact the administrator</code>
</div>
<hr style="width:60%;">

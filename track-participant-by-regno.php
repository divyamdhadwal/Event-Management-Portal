...
$sql2="SELECT id FROM eventdetails WHERE userid1='$myid' OR userid2='$myid' OR userid3='$myid'";
...
$sql1="SELECT * FROM eventregistrations WHERE participantregno='$regnumber' && eventid='$eventid'";
...
echo 'This registration number has no account of registration in your event';
}

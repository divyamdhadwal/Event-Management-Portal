...
$sql1="SELECT * FROM eventregistrations WHERE registrationid='$regid' && eventid='$eventid'";
...
echo 'This Registration ID has no account or history of registration in your event';
}
